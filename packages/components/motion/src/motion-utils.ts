import { MotionVariants as MotionVariantOptions } from "@vueuse/motion"
 ...
 */
export const TransitionVariants: MotionVariants = {
  scale: {
...
export type MotionVariant = keyof typeof TransitionVariants
