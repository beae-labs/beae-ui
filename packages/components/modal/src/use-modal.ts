...
import { useIds } from "@beae-ui/composables"
import {
  FocusLockProps,
  useReturnFocusSelector,
  useFocusTrap,
} from "@beae-ui/focus-lock"
import { MaybeElementRef, useRef, TemplateRef } from "@beae-ui/utils"
import { useInertOthers } from "@beae-ui/vue-a11y"
import { FocusableElement, isFunction } from "@beae-ui/utils"
...
export interface UseModalOptions {
  ...
  /**
   * If `true`, the body will not be scrollable when mounted
   * @default true
   */
