...
const ButtonSpinner: ComponentWithProps<DeepPartial<ButtonSpinnerProps>> =
  defineComponent({
    name: "ButtonSpinner",
    props: _buttonProps,
    setup(props, { attrs }) {
...
const ButtonIcon: ComponentWithProps<DeepPartial<IconProps>> = defineComponent({
  name: "ButtonIcon",
  props: {
...
export const Button: ComponentWithProps<DeepPartial<ButtonProps>> =
  defineComponent({
    name: "Button",
    props: {
      isLoading: {
