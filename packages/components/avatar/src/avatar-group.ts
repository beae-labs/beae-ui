import { WrapProps, Box, Wrap, WrapItem } from "@beae-ui/layout"
import { type ThemingProps, useMultiStyleConfig, beae } from "@beae-ui/system"
...
const [AvatarGroupProvider, useAvatarGroup]: any =
...
export const AvatarText = defineComponent({
  props: {
    text: {
