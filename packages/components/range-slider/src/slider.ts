...
const [SliderProvider, useSliderContext]: any = createContext<SliderContext>({
  name: "SliderContext",
  hookName: "useSliderContext",
  providerName: "<Slider />",
})

const [SliderStylesProvider, useSliderStyles]: any = createContext<
...
export const Slider = defineComponent({
  ...
  props: {
    ...
    focusThumbOnChange: Boolean as PropType<SliderProps["focusThumbOnChange"]>,
  ...
  setup(props, { slots, emit }) {
    ...
    // @ts-ignore
    const ownProps: any = omitThemingProps(sliderProps.value)
 ...
 */
export const SliderThumb: DefineComponent = defineComponent({
  name: "SliderThumb",
  setup(props, { slots }) {
...
export const SliderTrack: DefineComponent = defineComponent({
  name: "SliderTrack",
  setup(props, { slots }) {
...
export const SliderFilledTrack: DefineComponent = defineComponent({
 ...
 */
export const SliderMark: DefineComponent = defineComponent({
  name: "SliderMark",
  props: {
