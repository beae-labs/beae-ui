...
const [RangeSliderProvider, useRangeSliderContext]: any = createContext<
...
const [RangeSliderStylesProvider, useRangeSliderStyles]: any = createContext<
 ...
 */
export const RangeSliderMark = defineComponent({
