import type { BeaeTheme, Theme } from "@beae-ui/theme"

import { theme, baseTheme, isBeaeTheme } from "@beae-ui/theme"
...
export declare type ThemeOverride<BaseTheme = Theme> = DeepPartial<BeaeTheme> &
  DeepThemeExtension<BaseTheme, BeaeTheme> &
  Record<string, any>
 ...
 *
 * Function to override or customize the Beae UI theme conveniently.
 * First extension overrides the baseTheme and following extensions override the preceding extensions.
 *
 * @example:
 * import { theme as baseTheme, extendTheme, withDefaultColorScheme } from '@beae-ui/react'
 *
