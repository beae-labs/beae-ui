 ...
 * Augmentation feature and is an alternative to running `npx @beae-ui/cli
 * tokens`
 *
 * @example
 * ```ts
 * import { BaseThemeTypings } from "@beae-ui/styled-system";
 *
 * type DefaultSizes = 'small' | 'medium' | 'large';
 *
 * declare module "@beae-ui/styled-system" {
