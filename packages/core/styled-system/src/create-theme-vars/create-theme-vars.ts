 ...
 *
 * @example
 * tokenToCssVar('colors.red.500', 'beae')
 * => {
 *   variable: '--beae-colors-red-500',
 *   reference: 'var(--beae-colors-red-500)'
 * }
 */
    ...
    cssVars = mergeWith(
      ...
      Object.entries(normalizedValue).reduce(
        (acc, [conditionAlias, conditionValue]) => {
          ...
          /** @example { _dark: "#fff" } => { '.beae-ui-dark': "#fff" } */
